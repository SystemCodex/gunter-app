    ...
    const FEATURE_MAP = [
        ...
        },
        {
            ...
            subs: [
                { key: 'meetingSemanticSearch',    label: 'Búsqueda semántica en transcripciones',
                  hint: 'Ej: "¿qué dijo Juan sobre precios?"' },
        ...
        // ================ Premium Intelligence (Sprint A) ================
        {
            ...
            subs: [
                { key: 'dailyPlannerMorningBrief',     label: 'Brief matutino',
                  hint: 'Resumen rápido del día apenas abres Gunter.' },
                { key: 'dailyPlannerTimeBlocks',       label: 'Sugerir bloques de tiempo',
                  hint: 'Propone momentos del día para cada tarea.' },
        ...
        },
        {
            ...
            subs: [
                ...
                { key: 'weeklyPlannerCalendarBlocks',   label: 'Crear bloques en Calendar',
                  hint: 'Pide confirmación antes de crear eventos. Requiere Google Calendar.' },
        ...
        },
        {
            ...
            subs: [
                ...
                { key: 'projectExecutiveSummaryExport',    label: 'Permitir exportar como PDF' }
            ]
        },
        {
            ...
            <div class="gps-card ${enabled ? 'gps-card--active' : ''}" data-feature="${feature.id}">
                ...
                <div class="gps-card__details" data-details="${feature.id}">
                    ...
                    <div class="gps-sub" style="margin-top:6px;">
                        <div class="gps-sub__label">Coach de enfoque</div>
                        <button class="gps-switch" role="switch" aria-checked="${p.focusCoach}" data-switch="focusCoachEnabled"></button>
                    </div>
                    <div class="gps-sub">
                        <div class="gps-sub__label">Bloquear distracciones</div>
                        <button class="gps-switch" role="switch" aria-checked="${p.distractionBlocker}" data-switch="distractionBlocker"></button>
                    </div>
                    <div class="gps-sub">
                        <div class="gps-sub__label">Timer inteligente</div>
                        <button class="gps-switch" role="switch" aria-checked="${p.smartTimer}" data-switch="smartTimer"></button>
                    </div>
                </div>
            </div>
        `;
