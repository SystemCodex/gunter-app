...
(function () {
    const TABS = ['new-project', 'premium', 'preferences', 'trash', 'data'];
    const TITLES = {
        'new-project': { t: 'Nueva Reunión', s: 'Configura el contexto para que Gunter adapte su análisis.' },
    ...
    function activateTab(name) {
        if (!TABS.includes(name)) name = 'new-project';
    ...
    function initTabs() {
        ...
        const initial = (location.hash || '').replace('#', '') || 'new-project';
        activateTab(initial);
    }
