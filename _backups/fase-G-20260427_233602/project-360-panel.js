...
(function () {
    ...
    async function populateSelector() {
        ...
        try {
            ...
            if (!projects.length) {
                renderEmpty('No hay proyectos sincronizados todavía.');
            }
        } catch {
    ...
    function renderLoading() { $body().innerHTML = `<div class="gpi-loading"><div class="gpi-spinner"></div><span>Cargando vista 360…</span></div>`; }
