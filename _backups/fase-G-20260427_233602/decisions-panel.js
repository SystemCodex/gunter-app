...
(function () {
    ...
    function renderLoading() { $body().innerHTML = `<div class="gpi-loading"><div class="gpi-spinner"></div><span>Cargando decisiones…</span></div>`; }
    ...
    function renderList() {
        ...
        if (filtered.length === 0) {
            $body().innerHTML = `<div class="gpi-empty"><p>No hay decisiones que coincidan.</p><p>Usa <strong>+ Guardar decisión</strong> para registrar una nueva.</p></div>`;
            return;
        }
